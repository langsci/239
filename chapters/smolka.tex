...
\textit{Sie hat immer nach den Sternen/Planeten/Bonbons gegriffen.}    & \textit{Sie hat immer etwas Unerreichbares angestrebt.}                                      \\ \hline
(W) She has always for the stars/planets/sweets reached.               & (W) She has always something unreachable aspired.                                            \\ \hline
(L) She always reached for the stars/planets/sweets.                   & (L) She always aspired to something unreachable.                                             \\ \hline
(F) She always reached for the stars.                                  &                                                                                              \\ \hline
\textit{Sie haben die Katze im Sack/Beutel/Frühling gekauft.}          & \textit{Sie wurden beim ungeprüften Kauf übervorteilt.}                                      \\ \hline
(W) They have the cat in the sack/bag/spring bought.                   & (W) They were at the uninspected purchase outsmarted.                                        \\ \hline
(L) They bought the cat in the sack/bag/spring.                        & (L) They were outsmarted at the uninspected purchase.                                        \\ \hline
(F) They bought a pig in a poke.                                       &                                                                                              \\ \hline
\textit{Sie hat immer aufs falsche Pferd/Roß/Spielfeld gesetzt.}       & \textit{Sie hat die Lage immer falsch eingeschätzt und sich entsprechend falsch verhalten.}  \\ \hline
...
\multicolumn{1}{|c|}{\textbf{Idiomatic/Modified/Unrelated}}                     & \multicolumn{1}{c|}{\textbf{Paraphrase}}                                      \\ \hline
\textit{Sie hat immer nach den Sternen gegriffen/gelangt/gefragt.}              & \textit{Sie hat immer etwas Unerreichbares angestrebt.}                       \\ \hline
(W) She has always for the stars reached/grasped/asked.                         & (W) She has always something unreachable aspired.                             \\ \hline
(L) She always reached for/grasped at/ asked for the stars.                     & (L) She always aspired something unreachable.                                 \\ \hline
(F) She always reached for the stars.                                           &                                                                               \\ \hline
\textit{Mir ist ein Stein vom Herzen gefallen/gestürzt/ vom Dach gerollt.}      & \textit{Ich bin darüber sehr erleichtert gewesen.}                            \\ \hline
(W) To me is a stone from heart fallen/dropped/ from the roof rolled.           & (W) I have about that very relieved been.                                     \\ \hline
(L) A stone fell/dropped off the heart/ rolled off the roof.                    & (L) I was very relieved about that.                                           \\ \hline
(F) It took a load off my mind.                                                 &                                                                               \\ \hline
\textit{Er hat mir wieder einen Korb gegeben/gereicht/geflochten.}              & \textit{Er hat mich wieder abgewiesen.}                                       \\ \hline
(W) He has me again a basket given/handed/woven.                                & (W) He has me again rejected.                                                 \\ \hline
...
\textbf{Idiomatic/Modified/(Unrelated Prepositional Phrase)}                          & \textbf{Paraphrase}                                               \\ \hline
\textit{Sie hat immer nach/zu den Sternen/ (nach den Bonbons) gegriffen.}             & \textit{Sie hat immer etwas Unerreichbares angestrebt.}           \\ \hline
(W) She has always for/at the stars reached.                                          & (W) She has always something unreachable aspired.                 \\ \hline
(L) She always reached for/to the stars.                                              & (L) She always aspired something unreachable.                     \\ \hline
(F) She always reached for the stars.                                                 &                                                                   \\ \hline
\textit{Ich habe ihn sehr ins/ans Herz/ (ins Zimmer) geschlossen.}                    & \textit{Ich habe ihn sehr lieb gewonnen.}                         \\ \hline
(W) I have him very into/onto heart/ (into the room) locked.                          & (W) I have him very dear won.                                     \\ \hline
(L) I locked him into/onto my heart/ (into the room).                                 & (L) I like him very much.                                         \\ \hline
(F) I have grown very fond of him.                                                    &                                                                   \\ \hline
\textit{Sie sind auf/an keinen grünen Zweig/ (auf keinen grünen Golfplatz) gekommen.} & \textit{Trotz starker Bemühungen konnten sie sich nicht einigen.} \\ \hline
(W) They have on/at no green branch/ (on no green golf course) come.                  & (W) In spite of all efforts could they themselves not agree.      \\ \hline
...
\label{tab:stimulus}
\resizebox{\textwidth}{!}{\begin{tabular}{|l|l|l|c|c|c|}
\hline
 &  &  & \multicolumn{3}{c|}{\textbf{Type of Noun}} \\ \hline
 & \multicolumn{1}{c|}{\textbf{Idiomatic Phrase}} &  & \multicolumn{1}{l|}{\textbf{Idiomatic}} & \multicolumn{1}{l|}{\textbf{Modified}} & \multicolumn{1}{l|}{\textbf{Unrelated}} \\ \hline
Example & Sie hat nach den Sternen gegriffen &  & Sternen & Planeten & Bonbons \\ \hline
(translation) & (L: ‘She reached for the stars’) &  & (‘stars’) & (‘planets’) & (‘sweets’) \\ \hline
N &  &  & 39 & 39 & 39 \\ \hline
Lemma &  &  & 57.1 & 25.5 & 39.6 \\ \hline
Surface &  &  & 32.3 & 16.8 & 22.9 \\ \hline
Association &  &  & - & 5.8 & - \\ \hline
Closure &  &  & 93.1 & - & - \\ \hline
\end{tabular}}
...
\hline
 & \textbf{Estimate} & \textbf{Std. Error} & \textbf{df} & \textbf{t-value} & \textbf{p} &  \\ \hline
...
\hline
                     &                                    &           & \multicolumn{3}{c|}{\textbf{Type of Verb}}                  \\ \hline
                     & \textbf{Idiomatic Phrase}          & \textbf{} & \textbf{Idiomatic} & \textbf{Modified} & \textbf{Unrelated} \\ \hline
\textbf{Example}     & Sie hat nach den Sternen gegriffen &           & gegriffen          & gelangt           & gefragt            \\ \hline
\textbf{}            & (L: ‘She reached for the stars’)   &           & (‘reached’)        & (‘grasped’)       & (‘asked’)          \\ \hline
...
\hline
                 &                                                                                                      &           & \multicolumn{3}{c|}{\textbf{Type of Preposition}}              \\ \hline
                 & \textbf{Idiomatic Phrase}                                                                            & \textbf{} & \textbf{Idiomatic} & \textbf{Modified} & \textbf{Unrelated PP} \\ \hline
\textbf{Example} & Ich habe ihn ins Herz geschlossen                                                                    &           & ins                & ans               & ins Zimmer            \\ \hline
\textbf{}        & \begin{tabular}[c]{@{}c@{}}(L: I locked him into my heart; \\ \\ F: ‘I am fond of him’)\end{tabular} &           & (‘into’)           & (‘onto’)          & (‘into the room’)     \\ \hline
\textbf{N}       &                                                                                                      &           & 33                 & 33                & 33                    \\ \hline
...
\begin{table}[]
\caption{\textit{Fixed Effects of the Predictors in the Linear Mixed-Effect Model for the Paraphrase Ratings Combining}}
\label{tab:Table8}
\resizebox{\textwidth}{!}{\begin{tabular}{|c|c|c|c|c|c|}

\hline
 & \textbf{Estimate} & \textbf{Std. Error} & \textbf{t value} & \textbf{p} &  \\ \hline
