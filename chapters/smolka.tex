...
\title{\textit{Can you reach for the planets or grasp at the stars?} – 
...
\begin{table}[]
\resizebox{\textwidth}{!}{\begin{tabular}{|p{4in}|p{4in}|}

\hline
\multicolumn{2}{|c|}{\textbf{Verb Modification}}                                                                                                                \\ \hline
\multicolumn{1}{|c|}{\textbf{Idiomatic/Modified/Unrelated}}                     & \multicolumn{1}{c|}{\textbf{Paraphrase}}                                      \\ \hline
...
\hspace{3mm}(F) It took a load off my mind.                                                 &                                                                               \\ \hline
...
\hline
\multicolumn{2}{|c|}{\textbf{Preposition Modification}}                                                                                                   \\ \hline
\multicolumn{1}{|c|}{\textbf{Idiomatic/Modified/(Unrelated Prepositional Phrase)}}                     & \multicolumn{1}{c|}{\textbf{Paraphrase}}                                               \\ \hline
...
\hspace{3mm}(F) I have grown very fond of him.                                                    &                                                                   \\ \hline
...
\paragraph{Sentence completion task.}
...
\hline
 & \textbf{} & \multicolumn{3}{c|}{\textbf{Type of Noun}} \\ \hline
 & \textbf{Idiomatic Phrase} & \textbf{Idiomatic} & \textbf{Modified} & \textbf{Unrelated} \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}Example\\ (translation)\end{tabular}} & \begin{tabular}[c]{@{}c@{}}\textit{Sie hat nach den Sternen gegriffen}\\ (L: She reached for the stars')\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textit{Sternen}\\ (‘stars')\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textit{Planeten}\\ (‘planets')\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textit{Bonbons}\\ (‘sweets')\end{tabular} \\ \hline
\textbf{N} &  & 39 & 39 & 39 \\ \hline
\textbf{Lemma} &  & 57.1 & 25.5 & 39.6 \\ \hline
\textbf{Surface} &  & 32.3 & 16.8 & 22.9 \\ \hline
\textbf{Association} &  & - & 5.8 & - \\ \hline
\textbf{Closure} &  & 93.1 & - & - \\ \hline
\end{tabular}}
...
\label{tab:linear}
\resizebox{\textwidth}{!}{\begin{tabular}{|l|c|c|c|c|c|l|}

\hline
 & \textbf{Estimate} & \textbf{Std. Error} & \textbf{df} & \textbf{\textit{t}-value} & \textbf{\textit{p}} &  \\ \hline
(Intercept: Idiomatic) & 6.246 & 0.179 & 123.1 & 34.83 & \textless{}2.00e-16 & *** \\ \hline
Constituent (Modified) & -2.115 & 0.210 & 112.8 & -10.08 & \textless{}2.00e-16 & *** \\ \hline
Constituent (Unrelated) & -3.722 & 0.210 & 112.8 & -17.73 & \textless{}2.00e-16 & *** \\ \hline
\end{tabular}}
...
\hline
 & \textbf{} & \multicolumn{3}{c|}{\textbf{Type of Verb}} \\ \hline
 & \textbf{Idiomatic Phrase} & \textbf{Idiomatic} & \textbf{Modified} & \textbf{Unrelated} \\ \hline
\textbf{Example} & \begin{tabular}[c]{@{}c@{}}\textit{Sie hat nach den Sternen gegriffen}\\ (L: ‘She reached for the stars’)\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textit{gegriffen}\\ (‘reached')\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textit{gelangt}\\ (‘grasped')\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textit{gefragt}\\ (‘asked')\end{tabular} \\ \hline
\textbf{N} &  & 33 & 33 & 33 \\ \hline
\textbf{Lemma} &  & 135 & 69 & 440 \\ \hline
\textbf{Surface} &  & 18.5 & 7 & 24.5 \\ \hline
\textbf{Association} &  & - & 5.3 & - \\ \hline
\textbf{Closure} &  & 90.9 & 0.46 & - \\ \hline
\end{tabular}}
\footnotesize{\textit{Note.} N = number of items, Lemma = mean lemma frequency per one million, taken from CELEX \citep{baayen:1993}, Closure = mean sentence completion in \%.}
\end{table}

\paragraph{Verb association test.} 
...
\hline
 & \textbf{Estimate} & \textbf{Std. Error} & \textbf{df} & \textbf{\textit{t}-value} & \textbf{\textit{p}} &  \\ \hline
(Intercept: Idiomatic) & 6.538 & 0.1389 & 112.2 & 47.07 & \textless{}2.00e-16 & *** \\ \hline
Constituent (Modified) & -0.580 & 0.1852 & 93.61 & -3.13 & 0.00234 & * \\ \hline
Constituent (Unrelated) & -4.373 & 0.1853 & 93.68 & -23.61 & \textless{}2.00e-16 & *** \\ \hline
\end{tabular}}
\footnotesize{\textit{Note.} significance code: *** < .0001.}
\end{table}
...
\resizebox{\textwidth}{!}{\begin{tabular}{|c|c|c|c|c|}
\hline
 & \textbf{} & \multicolumn{3}{c|}{\textbf{Type of Preposition}} \\ \hline
 & \textbf{Idiomatic Phrase} & \textbf{Idiomatic} & \textbf{Modified} & \textbf{Unrelated PP} \\ \hline
\textbf{Example} & \begin{tabular}[c]{@{}c@{}}\textit{Ich habe ihn ins Herz geschlossen}\\ (L: 'I locked him into my heart';\\ F: 'I am fond of him')\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textit{ins}\\  (‘into')\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textit{ans}\\  (‘onto')\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textit{ins Zimmer}\\ (‘into the room')\end{tabular} \\ \hline
\textbf{N} &  & 33 & 33 & 33 \\ \hline
\textbf{Lemma} &  & 6.7 & 4.2 & - \\ \hline
\textbf{Closure} &  & 90.2 & - & - \\ \hline
\end{tabular}}
\footnotesize{\textit{Note.} N = number of items, Lemma = mean lemma frequency per one million, taken from CELEX \citep{baayen:1993}, Closure = mean sentence completion in \%.}
\end{table}
...
\paragraph{Paraphrases and fillers.}
...
\begin{table}[]
\caption{\textit{Fixed Effects of the Predictors in the Linear Mixed-Effect Model for the Paraphrase Ratings in Experiment 3.}}
\label{tab:Table7}
\resizebox{\textwidth}{!}{\begin{tabular}{|l|c|c|c|c|c|c|}

\hline
                        & \textbf{Estimate} & \textbf{Std. Error} & \textbf{df} & \textbf{\textit{t}-value} & \textbf{\textit{p}}          &     \\ \hline
(Intercept: Idiomatic)  & 6.260             & 0.1768              & 133.04      & 35.42            & \textless{}2.00e-16 & *** \\ \hline
Constituent (Modified)  & -0.973            & 0.2099              & 96.36       & -4.63            & 1.13e-05            & *** \\ \hline
Constituent (Unrelated) & -3.797            & 0.2099              & 96.40       & -18.09           & \textless{}2.00e-16 & *** \\ \hline
\end{tabular}}
\footnotesize{\textit{Note.} significance code: *** < .0001 }
\end{table}
...
\begin{table}[]
\caption{\textit{Fixed Effects of the Predictors in the Linear Mixed-Effect Model for the Paraphrase Ratings Combining Experiments 1--3.}}
\label{tab:Table8}
\resizebox{\textwidth}{!}{\begin{tabular}{|l|c|c|c|c|c|}

\hline
 & \textbf{Estimate} & \textbf{Std. Error} & \textbf{\textit{t}-value} & \textbf{\textit{p}} &  \\ \hline
(Intercept: Idiomatic, Noun) & 6.245 & 0.159 & 39.18 & \textless{}2.00e-1 & *** \\ \hline
Constituent (Modified) & -2.115 & 0.193 & -10.96 & \textless{}2.00e-1 & *** \\ \hline
Constituent (Unrelated) & -3.895 & 0.183 & -21.25 & \textless{}2.00e-1 & *** \\ \hline
Experiment (Preposition) & 0.033 & 0.161 & 0.20 & 0.8396 &  \\ \hline
Experiment (Verb) & 0.381 & 0.161 & 2.38 & 0.0182 & * \\ \hline
Constituent (Modified) x Experiment (Prep.) & 1.122 & 0.233 & 4.82 & 2.09e-06 & *** \\ \hline
Constituent (Unrelated) x Experiment (Prep.) & 0.248 & 0.177 & 1.40 & 0.1613 &  \\ \hline
Constituent (Modified) x Experiment (Verb) & 1.454 & 0.233 & 6.24 & 1.18e-09 & *** \\ \hline
Constituent (Unrelated) x Experiment (Verb) & -0.443 & 0.214 & -2.07 & 0.0386 & * \\ \hline
\end{tabular}}
\footnotesize{\textit{Note.} significance code: *** < .0001, * < .05.}
\end{table}
