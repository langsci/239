...
\begin{enumerate}
\item the letter before the first constituent boundary (e.g., ‘m’ in \textit{clampeel}). This is on the intercept; 
\item the letter at the first constituent boundary (e.g., ‘p’ in \textit{clampeel});
\item the letter at the second constituent boundary (e.g., the first ‘e’ in \textit{clampeel});
\item the letter after the second constituent boundary (e.g., the second ‘e’ in \textit{clampeel});
\end{enumerate}
