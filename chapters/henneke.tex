...
\ea\relax [ N1 \textit{de/a} N2 \textsubscript{TYPE/SPECIFICATION}]\textsubscript{N}>		\textit{freno de/a disco},	`disk brake'\z
...
\begin{minipage}{0.5\textwidth}    %an der Zahl 0.4 kannst du herumspielen für die Breite
...
\end{minipage}
\hfill            %für den Abstand zwischen den Spalten, Leerzeilen funktionieren nicht
...
For the French data, a very different pattern appears in the analysis of internal variability of \textit{de} and \textit{à}:\\  
 ...
 \begin{minipage}{0.4\textwidth}    %an der Zahl 0.4 kannst du herumspielen für die Breite
...
\end{minipage}
\hfill            %für den Abstand zwischen den Spalten, Leerzeilen 
\begin{minipage}{0.5\textwidth}
