...
\hline
Predictor          & \multicolumn{2}{c|}{SUB} & \multicolumn{2}{c|}{ATT} & \multicolumn{2}{c|}{CRD} & \multicolumn{2}{c|}{Total}  \\ \hline
                   & \textit{mean}   & \textit{sd}   & \textit{mean}    & \textit{sd}   & \textit{mean}   & \textit{sd}   & \textit{mean} & \textit{sd} \\ \hline
...
PMI                & 3.53            & 4.00             & 4.83             & 4.80           & 4.34            & 3.47          & 4.11          & 4.27        \\ \hline
\textit{Num items} & \multicolumn{2}{c|}{67}          & \multicolumn{2}{c|}{49}          & \multicolumn{2}{c|}{16}         & \multicolumn{2}{c|}{132}    \\ \hline
\end{tabular}
